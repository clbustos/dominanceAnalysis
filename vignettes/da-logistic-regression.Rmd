...
To evaluate the robustness of our results, we use bootstrapping analysis by using `bootDominanceAnalysis()` function.

```{r}
bootmodpres1000 <- bootDominanceAnalysis(modpres, R=100)
summary(bootmodpres1000,fit.functions="r2.m")
```
